...
import ReadingProgressHistory from "@/components/books/book-details/reading-progress-history-table";
        ...
        <div className="flex w-full flex-col items-center gap-y-4 lg:w-3/4 lg:flex-row lg:items-start lg:gap-x-4">
          ...
          <div className="flex w-full flex-col gap-y-2 lg:w-3/4">
            ...
            {book.summary && (
              <div
                className={cn(
                  "border-primary rounded-md border p-1 text-sm leading-5 font-normal text-pretty whitespace-pre-line lg:border-0",
                  isReading
